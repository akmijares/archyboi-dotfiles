...
alias opti-pihole='ssh root@10.0.0.39'
alias lb-pihole='ssh karlo@10.0.0.49'
...
alias proxy='ssh karlo@npm.sp33dyboi.xyz -p 4252'
alias up='ssh karlo@up.sp33dyboi.xyz -p 2252'
